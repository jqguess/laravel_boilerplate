...
<nav class="navbar navbar-inverse">
    <div class="container">
        <ul class="nav nav-pills navbar-left">
            ...
            <li class="active">
                <a class="nav-right-top" href="https://laravel.com">
                            Laravel
                        </a>
            </li>
            <li class="active">
                <a class="nav-right-top" href="http://gulpjs.com">
                            Gulp
                        </a>
            </li>
            <li class="active">
                <a class="nav-right-top" href="http://php.net">
                            PHP 7
                        </a>
            </li>
        </ul>
...
<nav class="navbar navbar-default">
    <div class="container-fluid">
        <div class="navbar-header">
            ...
            <a class="navbar-brand" href="http://jqguess.net">Laravel</a>
        </div>
        ...
        <div class="container" style="padding-top: 200px;">
            <div class="row">
                <div class="col-sm-12" style="text-align:center; float:none;">
                    <p>Copyright @ MIT; <a href="#">Plain and Simple</a>  | Designed by JQGuess  <a href=""><i class="fa fa-github-square fa-lg"></i></a> |
                        <a href=""><i class="fa fa-linkedin fa-lg"></i></a> </p>
                </div>
            </div>
        </div>
    </div>
